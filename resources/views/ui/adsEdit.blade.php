...
<div class="container mb-5 w-50 mx-auto">
    ...
    <form class="mt-3" action="{{ route('ads.update', $ad->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Luas Lahan Dalam Hektar</label>
        ...
        <div class="mb-3">
            ...
            <input type="number" id="myInput" oninput="formatNumberWithCommas()" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $ad->price) }}" {{ $ad->condition == 1 ? 'disabled' : '' }}>
            @error('price')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="idOfTextField" name="irigation" aria-label="Default select example">
                <option value="{{ $ad->irigation }}">{{ $ad->irigation }}</option>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="road" aria-label="Default select example">
                <option value="{{ $facility->road }}">{{ $facility->road }}</option>
