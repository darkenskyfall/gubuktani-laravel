...
<div class="container mb-5">
    <h1 style="margin-top:100px;">Bantuan</h1>
    ...
    <ul class="list-group mt-3">
        ...
        <li class="list-group-item disabled">Klik Daftar</li>
        <li class="list-group-item disabled">Selesai</li>
    </ul>
    ...
    <ul class="list-group mt-3">
        ...
        <li class="list-group-item disabled">Setelah itu klik kirim data</li>
        <li class="list-group-item disabled">Selesai</li>
    </ul>
