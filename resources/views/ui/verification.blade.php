...
<head>
    ...
    <title>Gubuktani - Verifikasi Email</title>
    ...
    <main>
        <div class="container mb-5 w-50 mx-auto">
            <center>
                ...
                <h2 class="display-6">Gubuktani.online</h2>
            </center>
            <h1 style="margin-top:40px;">Verifikasi Email</h1>


            <p>Halo,</p>
            <p>Terima kasih telah mendaftar di Gubuktani! Untuk mengaktifkan akun Anda, silakan cek email anda untuk memverifikasi alamat email anda.</p>
            
            <p>Setelah melakukan verifikasi, Anda akan dapat mengakses semua fitur Gubuktani. Jika Anda tidak menemukan email verifikasi, periksa folder "Spam" atau "Promosi" di email Anda.</p>

            <p>Terima kasih</p>
            <p><b>Tim Gubuktani</b></p>

            <form action="{{ route('resend.verification') }}" method="post">
                @csrf
                <input type="hidden" name="id" value="{{ $id }}">
                <input type="hidden" name="email" value="{{ $email }}">
                <button type="submit" class="btn btn-success">Kirim Ulang Verifikasi Email</button>
            </form>
